...
function StandingsCriteriaBox({ tiebreakerOrder, penaltyResults }: { tiebreakerOrder?: TiebreakerCriterion[]; penaltyResults?: Array<{ teamAId: string; teamBId: string; teamAScore: number; teamBScore: number }> }) {
  const { t } = useI18n();
