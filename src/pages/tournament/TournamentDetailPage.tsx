...
function AdminRosterSheet({ tournament, team, rosterMap, onClose }: {
  tournament: Tournament;
  team: Team;
      ...
      <div onClick={e => e.stopPropagation()} style={{ background: 'var(--surface)', borderRadius: '24px 24px 0 0', width: '100%', maxWidth: 480, padding: '0 0 32px', maxHeight: '90dvh', overflowY: 'auto' }}>
        ...
        <div style={{ padding: '8px 20px 0', display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <button onClick={onClose} style={{ background: 'var(--surface-var)', width: 32, height: 32, borderRadius: 16, border: 'none', fontSize: 16, color: 'var(--text-muted)', cursor: 'pointer' }}>✕</button>
          </div>
